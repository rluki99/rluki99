...
🌐 In my development process, I have acquired and am constantly developing skills in: JavaScript, CSS3, SCSS, BEM, HTML5, Vue3, Vue Router, Pinia, Gulp, Webpack, Vite, Parcel, Babel, Git/GitHub, WordPress, ProcessWire, PHP, Lazy Blocks, Node.js, NPM, NVM, Figma, Photoshop, UI/UX, ClickUp, Jira, Trello, Supabase, Firebase. I am ready to learn more technologies and tools and take on new challenges.
...
[![My Skills](https://skillicons.dev/icons?i=js,html,css,sass,gulp,babel,webpack,vite,vue,nodejs,git,github,php,wordpress,ps,figma,supabase,firebase)]()
